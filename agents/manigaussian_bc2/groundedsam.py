...
class GroundedSAM:
    def __init__(self):
        ...
        self.box_threshold = 0.2 # 5 #0.3 # 学长0.3原来0.35?
    ...
    def test(self):
        ...
        output_dir = "/data1/zjyang/program/peract_bimanual/scripts/test_demo/4/20/2"
        # device = args.device
        # Source image path
        ...
        # image_path="/data1/zjyang/program/peract_bimanual/data_ntu/zips/handover_keyframe/all_variations/episodes/episode0/nerf_data/2/images/0.png"
        image_path="/data1/zjyang/program/peract_bimanual/scripts/test_demo/4/20/1.png"
