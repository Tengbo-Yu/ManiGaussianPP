...
eval_type=80000 # ,85000,95000] # [50000,22000,24000,28000] #[20000,30000,40000,50000,60000,70000]  # [32000,37000,39000,43000,60000,70000,65000] #[5000,15000,25000,35000,51000,59000,61000,82000,89000] # [58000,62000,15000,25000,35000,52000,65000,75000,85000] # 90000    # "[20000,65000,49000,51000]" # 80000 #'last' # or 'best', 'missing', or 'last' or 'all'
camera=False
eval_episodes=100 # 100 #25 #eval每个task的轮数
# camera=False # 是否录制视频
